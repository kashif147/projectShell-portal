    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Please provide your subscription preferences and payment information.
        </p>
        ...
        <div className="space-y-4">
          <div className="flex items-start">
            <Checkbox
              label={
                <div>
                  <span className="font-semibold text-gray-900">Tick here to join INMO Income Protection Scheme</span>
                  <p className="text-xs text-gray-500 mt-1">
                    Available for new members and graduates only
                  </p>
                </div>
              }
          ...
          <div className="flex items-start">
            <Checkbox
              label={
                <div>
                  <span className="font-semibold text-gray-900">Tick here to join Rewards for INMO members</span>
                  <p className="text-xs text-gray-500 mt-1">
                    Available for new members and graduates only
                  </p>
                </div>
