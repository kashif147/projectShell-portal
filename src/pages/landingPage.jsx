...
const LandingPage = () => {
  ...
  const portalFeatures = [
    { label: 'Personal Dashboard', icon: DashboardOutlined },
    { label: 'Issue Management', icon: ToolOutlined },
    { label: 'Apply for Membership', icon: SolutionOutlined },
    { label: 'Events & Workshops', icon: CalendarOutlined },
    { label: 'Member Resources', icon: BookOutlined },
    { label: 'Learning Courses', icon: ReadOutlined },
    { label: 'Messages & Notifications', icon: MessageOutlined },
    { label: 'Secure Payments', icon: CreditCardOutlined },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white lg:flex-row">
      <div className="relative w-full overflow-hidden p-8 text-white md:p-14 lg:w-1/2">
        <img
          src={`https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=1200`}
          alt="Members collaborating"
          className="absolute inset-0 h-full w-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-br from-[#3f3d8f]/95 via-[#4e4bb0]/90 to-[#2d2b6b]/95" />
        <div className="absolute inset-0 bg-gradient-to-tr from-indigo-900/45 to-transparent" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(96,165,250,0.28),_transparent_45%)]" />
      ...
      <div className="flex w-full items-center justify-center bg-slate-50 p-6 md:p-10 lg:w-1/2">
